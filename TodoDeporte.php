...
$apellido_pa = $_SESSION["APELLIDO1"];
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        ...
                        <li>
                              ...
                              <h3>
                            <?php echo $nombre, $apellido_pa; ?>
                              </h3>
                            <br>
                              <a  href="logout.php" class="btn btn-success btn-lg">
                                Editar cuenta
                            </a>

                              <a  href="acceso/logout.php" class="btn btn-warning btn-lg">
                                Cerrar Sesion
                            </a>
   ...
   <!-- FEATURES SECTION END-->
    ...
    <div class="container set-pad">
		   ...
		   <div id="brand-sec" class="container set-pad" >
			 ...
			 <img class="img img-rounded img-responsive" src="img/marcas.png"  style="width:900px;height:1100px;"/>
<br>
<br>
               </div>
             </div>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
          &copy 2019 Shopping LITE| All Rights Reserved |  <a style="color: #fff" target="_blank">Design by : Anthon</a>
    </div>
     <!-- FOOTER SECTION END-->
